  ...
  def destroy
    respond_to do |format|
      if @category.destroy!
        ...
        format.html { redirect_to categories_path, alert: "Category cannot be destroyed.", status: :see_other }
        format.json { render json: "Category cannot be destroyed.", status: :unprocessable_entity }
      end
    end
  end
